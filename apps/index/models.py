...
class Product(models.Model):
    category = models.ForeignKey('Category', related_name='products', on_delete=models.PROTECT, verbose_name='Kategoriya')
    name = models.CharField(max_length=200, db_index=True, verbose_name="Ism")
    ...
    weight = models.DecimalField(max_digits=10, decimal_places=1, verbose_name="Og'irligi")
